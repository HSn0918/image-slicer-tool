...
export function AppFrame({ children }: { children: ReactNode }) {
  return (
    <div className="flex min-h-screen flex-col bg-muted/20">
      <div className="mx-auto flex w-full max-w-[90rem] flex-1 gap-6 px-4 py-10 sm:px-6 lg:px-10">
      ...
      <footer className="border-t border-border/60 bg-background/80 py-6">
        <div className="mx-auto flex w-full max-w-[90rem] flex-col gap-4 px-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-10">
